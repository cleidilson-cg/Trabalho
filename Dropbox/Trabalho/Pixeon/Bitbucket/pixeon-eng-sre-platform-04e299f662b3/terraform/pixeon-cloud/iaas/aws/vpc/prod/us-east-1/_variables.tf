...
variable "vpc_cidr" {
  type    = "string"
  default = "10.224.64.0/18"
}

variable "private_subnet_a_cidr" {
  type    = "string"
  default = "10.224.64.0/22"
}


variable "private_subnet_b_cidr" {
  type    = "string"
  default = "10.224.68.0/22"
}


variable "private_subnet_c_cidr" {
  type    = "string"
  default = "10.224.72.0/22"
}

variable "public_subnet_a_cidr" {
  type    = "string"
  default = "10.224.76.0/22"
}

variable "public_subnet_b_cidr" {
  type    = "string"
  default = "10.224.80.0/22"
}


variable "public_subnet_c_cidr" {
  type    = "string"
  default = "10.224.84.0/22"
}
